...
class BiometricPasswordVault(private val context: Context) {
    ...
    fun enrollEncryptPassword(
        ...
        val promptInfo = BiometricPrompt.PromptInfo.Builder()
            .setTitle(activity.getString(com.wudongsong.keyring.R.string.biometric_prompt_title))
            .setSubtitle(activity.getString(com.wudongsong.keyring.R.string.biometric_prompt_enroll_subtitle))
    ...
    fun authenticateDecryptPassword(
        ...
        val promptInfo = BiometricPrompt.PromptInfo.Builder()
            .setTitle(activity.getString(com.wudongsong.keyring.R.string.biometric_prompt_title))
            .setSubtitle(activity.getString(com.wudongsong.keyring.R.string.biometric_prompt_unlock_subtitle))
            .setNegativeButtonText(activity.getString(android.R.string.cancel))
            .setAllowedAuthenticators(BiometricManager.Authenticators.BIOMETRIC_STRONG)
            .build()
        try {
